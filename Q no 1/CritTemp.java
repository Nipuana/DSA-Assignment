...
public class CritTemp {
    ...
    public static void main(String[] args) {
        System.out.println(minMeasurements(2, 10)); // Example: 4
        System.out.println(minMeasurements(3, 20)); // Example: 5
        System.out.println(minMeasurements(4, 30)); // Example: 6
    }
}
